...
var AuthMiddleware_1 = require("../../providers/middlewares/AuthMiddleware");
...
cafeRouter.get("/cafe", AuthMiddleware_1.isAuthenticated, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ViewCafeUseCase_1.viewCafeUseCase.readAll()];
            case 1:
                cafes = _a.sent();
                return [2 /*return*/, res.status(ServerTypes_1.HttpStatus.OK).send(cafes)];
        }
    });
}); });
